...
browser.find_element_by_xpath("/html/body/div[2]/div[2]/div/ul[2]/li[2]/ul/li[4]/a").click()
time.sleep(8)

browser.switch_to.frame(browser.find_element_by_name("frmSFBody"))
test = browser.find_element_by_id("inp_fileupload")
time.sleep(5)
test.sendKeys("D:\\template_customfield.xls")
time.sleep(15)
